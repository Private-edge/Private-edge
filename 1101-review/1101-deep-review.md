# بررسی عمیق 1101 در نسخهٔ 1.1.8 (فیکس v2rayNG)
...
## چرا 1101 در v8 عملاً غیرممکن است؟ (زنجیره‌های هندل‌شده)
...
**کد v8 (با فیکس v2rayNG) از نظر 1101 کاملاً تمیز است.** هیچ promise رهاشده‌ای، هیچ مسیر throw فراری، و هیچ race مهلکی پیدا نشد. تمام خطاهای ممکن به یکی از این سه ختم می‌شوند:
- **404** (خطاهای HTTP/route/env)
